# python-challenge
This is the repository for the Python homework assignment.

This repository contains two main folders, PyBank and PyPoll, one for each challenge.  The main python scripts for the PyBank and PyPoll challenges are contained in the corresponding folder.  The PyBank folder includes the budget data csv file used to run the analysis and the text file output with the financial analysis for the PyBank challenge.  The PyPoll folder includes the election data csv file used to run the analysis and the text file output with the election results for the PyPoll challenge.
